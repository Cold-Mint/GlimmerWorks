...
namespace glimmer {
    class CommandExecutor {
         ...
         * @return
         */
        static CommandResult Execute(const std::string &command, const CommandManager *commandManager,
    ...
    public:
         ...
         * @param onMessage onMessage 当输出消息时
         */
        static void ExecuteAsyncBatch(const std::vector<std::string> &commandList, const CommandManager *commandManager,
         ...
         * @param onMessage onMessage 当输出消息时
         */
        static void ExecuteAsyncSingle(const std::string &command, const CommandManager *commandManager,
