...
namespace glimmer
{
    class HorizontalLayoutStepper : public ILayoutStepper
    {
        DesignDimension cellWidth_;
    ...
    public:
        HorizontalLayoutStepper(DesignDimension cellWidth, const DesignVector2D& startPosition,
