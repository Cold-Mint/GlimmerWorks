...
const std::string_view glimmer::BiomeDecorsAssetEnumerator::GetAssetType() const
{
    return assetName;
}
...
std::optional<std::string> glimmer::BiomeDecorsAssetEnumerator::ListAsset(const AppContext* appContext)
{
    ...
    const BiomeDecoratorResourcesManager* decoratorResourcesManager = appContext->GetBiomeDecoratorResourcesManager();
