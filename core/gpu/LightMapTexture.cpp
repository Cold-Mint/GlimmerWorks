...
void glimmer::LightMapTexture::EnsureTexture(const Uint32 width, const Uint32 height) {
    ...
    width_ = width;
    height_ = height;
    LogCat::d(LogLabel::DEFAULT, "light_map_texture_ensure_created",
              "LightMapTexture::EnsureTexture created texture: {}x{}", width,
              height);
}
...
void glimmer::LightMapTexture::Update(SDL_GPUDevice *device, const LightBuffer *lightBuffer,
    ...
    LogCat::i(LogLabel::DEFAULT, "light_map_texture_update_build",
...
void glimmer::LightMapTexture::Upload(SDL_GPUCommandBuffer *commandBuffer) {
    ...
    dirty_ = false;
    LogCat::d(LogLabel::DEFAULT, "light_map_texture_upload_complete",
