...
void glimmer::PreloadColors::LoadAllColors(const ResourceLocator *resourceLocator) {
    ...
    Color debugPanelTextBGColorRes;
    ...
    Color defaultLightTransmissionRes;
