...
static constexpr std::string DIMENSION_COMMAND_NAME = "dimension";
...
static constexpr std::string DATA_PACK_SUGGESTIONS_NAME = "&data_pack";
...
static constexpr std::string SCENE_DYNAMIC_SUGGESTIONS_NAME = "&scene";
static constexpr std::string STRUCTURE_DYNAMIC_SUGGESTIONS_NAME = "&structure";
static constexpr std::string SCENE_NAME_MAIN = "main";
static constexpr std::string SCENE_NAME_SAVED_GAMES = "savedGames";
static constexpr std::string SCENE_NAME_CREATE_WORLD = "createWorld";
static constexpr std::string SCENE_NAME_SPLASH = "splash";
...
static constexpr std::string MATERIAL_ITEM_DYNAMIC_SUGGESTIONS_NAME = "&material_item";
...
static constexpr std::string DIMENSION_DYNAMIC_SUGGESTIONS_NAME = "&dimension";
static constexpr std::string ALLOC_STRATEGY_TYPE_DYNAMIC_SUGGESTIONS_NAME = "&alloc_strategy";
static constexpr std::string AUDIO_TRACK_DYNAMIC_SUGGESTIONS_NAME = "&audio_track";
static constexpr std::string ALLOC_STR_STRATEGY_FORWARD = "forward";
static constexpr std::string ALLOC_STR_STRATEGY_BACKWARD = "backward";
static constexpr std::string ALLOC_STR_STRATEGY_BALANCE = "balance";
static constexpr std::string ALLOC_STR_STRATEGY_RANDOM = "random";
static constexpr std::string AUDIO_TRACK_BGM = "bgm";
static constexpr std::string AUDIO_TRACK_AMBIENT = "ambient";
...
static const std::string DATA_FILE_TYPE_SPACING_STRUCTURE_CONDITION = "spacing_structure_condition";
static const std::string DATA_FILE_TYPE_SURFACE_STRUCTURE_CONDITION = "surface_structure_condition";
static const std::string DATA_FILE_TYPE_LIGHT_GROWTH_CONDITION = "light_growth_condition";
static const std::string DATA_FILE_TYPE_BIOME_GROWTH_CONDITION = "biome_growth_condition";
static const std::string DATA_FILE_TYPE_ADJACENT_TILE_GROWTH_CONDITION = "adjacent_tile_growth_condition";
static const std::string DATA_FILE_TYPE_HEIGHT_GROWTH_CONDITION = "height_growth_condition";
static const std::string DATA_FILE_TYPE_TIME_GROWTH_CONDITION = "time_growth_condition";
...
static constexpr std::string PIPELINE_NAME_GAME = "game";
static constexpr std::string PIPELINE_NAME_UI = "ui";
static constexpr std::string PIPELINE_NAME_GLOBAL = "global";
