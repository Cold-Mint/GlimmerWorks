...
namespace glimmer {
    class CommandHookManager {
        ...
        std::unordered_map<SDL_Scancode, std::vector<CommandHookEntry *> > sessionCommandHookMap_;
        std::unordered_map<SDL_Scancode, std::vector<CommandHookEntry *> > configCommandHookMap_;
        std::vector<CommandHookEntry *> fullVector_;


        [[nodiscard]] bool Exist(CommandHookScope scope,
                                 SDL_Scancode scancode, const std::string &command) const;
    ...
    public:
        ...
        [[nodiscard]] const std::vector<CommandHookEntry *> &GetCommandHookVector(SDL_Scancode scancode);
        ...
        [[nodiscard]] std::unique_ptr<CommandHookEntry> CreateCommandHookEntry(
            CommandHookScope scope, SDL_Scancode scancode, const std::string &command) const;
